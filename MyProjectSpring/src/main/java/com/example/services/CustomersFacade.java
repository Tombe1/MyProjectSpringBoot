...
import com.example.exceptions.CouponPurchasedException;
import com.example.exceptions.CustomerNotFoundException;
import com.example.exceptions.ExpiredCouponException;
import com.example.exceptions.NoCouponsException;
...
public class CustomersFacade extends ClientFacade {
	...
	private List<Coupons> getCustomerCoupons() throws CustomerNotFoundException {
